...
class Solution:
    def findCheapestPrice(self, n: int, flights: List[List[int]], src: int, dst: int, K: int) -> int:
        """
        DFS brute force, find all path from src to dst and return the cheapest one
        """
...
# Runtime: 1568 ms, faster than 5.00% of Python3 online submissions for Cheapest Flights Within K Stops.
# Memory Usage: 14.5 MB, less than 93.46% of Python3 online submissions for Cheapest Flights Within K Stops.

# If without early stop it will TLE
# 17
