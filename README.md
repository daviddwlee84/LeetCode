...
|   443|Medium  |[String Compression](https://leetcode.com/problems/string-compression/)|2023/3/2|String|[Naive-O(n)](Python3/String/StringCompression/Naive443.py)||More elegant solution (without clear the array)
