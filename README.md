...
|👍 045|Medium *|[Jump Game II](https://leetcode.com/problems/jump-game-ii/)|2020/10/14|Array|[DP-O(n^2)](Python3/Array/JumpGameII/DP045.py), [Greedy-O(n^2)](Python3/Array/JumpGameII/Greedy045.py), [BFS-O(n^2)](Python3/Array/JumpGameII/BFS045.py)||do it again with all solutions
...
|👍 239|Hard * |[Sliding Window Maximum](https://leetcode.com/problems/sliding-window-maximum/)|TODO|Array|[Naive-O(n^2)](Python3/Array/SlidingWindowMaximum/Naive239.py), [Monotonic Queue-O(n)](Python3/Array/SlidingWindowMaximum/MonotonicQueue239.py)|Dropbox OA|-
...
|👍 538|Easy    |[Convert BST to Greater Tree](https://leetcode.com/problems/convert-bst-to-greater-tree/)|TODO|BinaryTree||same as problem 1038|testcase
...
|👍 784|Easy    |[Letter Case Permutation](https://leetcode.com/problems/letter-case-permutation/)|2020/7/25|String|[Naive-O(n)](Python3/String/LetterCasePermutation/Naive784.py)||testcase, more elegant way
...
|👍 1249|Medium *|[Minimum Remove to Make Valid Parentheses](https://leetcode.com/problems/minimum-remove-to-make-valid-parentheses/)|2020/7/25|String|[Naive-O(n)](Python3/Array/MinimumRemoveToMakeValidParentheses/Naive1249.py)||testcase, do it again, follow up: O(1) space
...
|   1342|Easy    |[Number of Steps to Reduce a Number to Zero](https://leetcode.com/problems/number-of-steps-to-reduce-a-number-to-zero/)|2020/9/20|Math|[Naive-O(n)](Python3/Math/NumberOfStepsToReduceANumberToZero/Naive1342.py)||(good for beginners)
...
|👍 1547|Hard  |[Minimum Cost to Cut a Stick](https://leetcode.com/problems/minimum-cost-to-cut-a-stick/)|2020/10/17|Array|[Top-Down DP-O(n^2)](Python3/Array/MinimumCostToCutAStick/TopDownDP1547.py)|FreeWheel 2021 OA, [Weekly Contest 201](Contest/README.md#Weekly-Contest-201)|testcase
