...
|👍 402|Medium *|[Queue Reconstruction by Height](https://leetcode.com/problems/queue-reconstruction-by-height/)|2020/6/6|Array|[Sorting-O(n^2)](Python3/Array/QueueReconstructionByHeight/Sorting402.py), [InsertFromLowest-O(n)](Python3/Array/QueueReconstructionByHeight/InsertFromLowest402.py)|[Note](Python3/Array/QueueReconstructionByHeight/Note402.md)|do it again, testcase
