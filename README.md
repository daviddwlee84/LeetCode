...
|👍 2439|Medium  |[Minimize Maximum of Array](https://leetcode.com/problems/minimize-maximum-of-array/)|2023/4/5|Array|[GreedyBruteForce-O(n*max(nums))](Python3/Array/MinimizeMaximumOfArray/GreedyBruteForce2439.py), [Binary Search-O(n*max(nums))](Python3/Array/MinimizeMaximumOfArray/BinarySearch2439.py)||-
