...
|👍 053|Medium *|[Maximum Subarray](https://leetcode.com/problems/maximum-subarray/)|2018/6/12|Array|[BruteForce-O(n³)](Python3/Array/MaximumSubarray/Naive053.py), [DP-O(n)](Python3/Array/MaximumSubarray/DP053.py), [DC-O(nlogn)](Python3/Array/MaximumSubarray/DC053.py)|[Note](Python3/Array/MaximumSubarray/Note053.md)|Do it again
...
|👍 064|Medium *|[Minimum Path Sum](https://leetcode.com/problems/minimum-path-sum/)|2020/4/19|Array|[Backtracking-O(n!)](Python3/Array/MinimumPathSum/Backtracking064.py), [Backtracking With Early Stop-O(n!)](Python3/Array/MinimumPathSum/BacktrackingWithEarlyStop064.py), [Naive-O(mn)](Python3/Array/MinimumPathSum/Naive064.py), [NoAdditionalSpace-O(mn)](Python3/Array/MinimumPathSum/NoAdditionalSpace064.py), [DP-O(mn)](Python3/Array/MinimumPathSum/DP064.py)||-
...
|  067|Easy    |[Add Binary](https://leetcode.com/problems/add-binary/)|2019/10/22|String|[Adder-O(n)](Python3/String/AddBinary/Adder067.py), [Iterative-O(n)](Python3/String/AddBinary/Iterative067.py), [Python-O(n)](Python3/String/AddBinary/Python067.py)|-|-
...
|  071|Medium  |[Simplify Path](https://leetcode.com/problems/simplify-path/)|2019/12/17|String|[Stack-O(n)](Python3/String/SimplifyPath/Stack071.py), [Naive-O(n)](Python3/String/SimplifyPath/Naive071.py), [Stack 2-O(n)](Python3/String/SimplifyPath/Stack2_071.py)|[Note](Python3/String/SimplifyPath/Note071.md)|-
|👍 072|Hard *  |[Edit Distance](https://leetcode.com/problems/edit-distance/)|2019/10/30|String|[DP-O(mn)](Python3/String/EditDistance/DP072.py), [Recursive-O(mⁿ)](Python3/String/EditDistance/Recursive072.py), [Recursive With Memory-O(mn)](Python3/String/EditDistance/RecursiveWithMemory072.py), [DP 2-O(mn)](Python3/String/EditDistance/DP2_072.py)|[Note](Python3/String/EditDistance/Note072.md), Baidu Interview|-
...
|👍 101|Easy ▲  |[Symmetric Tree](https://leetcode.com/problems/symmetric-tree/)|2018/6/8|Binary Tree|[Recursive-O(n)](Python3/BinaryTree/SymmetricTree/Recursive101.py), [Iterative-O(n)](Python3/BinaryTree/SymmetricTree/Iterative101.py), [Preorder-O(n)](Python3/BinaryTree/SymmetricTree/Preorder101.py), [Iterative BFS-O(n)](Python3/BinaryTree/SymmetricTree/IterativeBFS101.py)|[Note](Python3/BinaryTree/SymmetricTree/Note101.md)|-
...
|👍 103|Medium *|[Binary Tree Zigzag Level Order Traversal](https://leetcode.com/problems/binary-tree-zigzag-level-order-traversal/)|2020/7/22|Binary Tree|[Naive-O(n)](Python3/BinaryTree/BinaryTreeZigzagLevelOrderTraversal/Naive103.py), [Without Reverse-O(n)](Python3/BinaryTree/BinaryTreeZigzagLevelOrderTraversal/WithoutReverse103.py), [BFS-O(n)](Python3/BinaryTree/BinaryTreeZigzagLevelOrderTraversal/BFS103.py), [Without Reverse 2-O(n)](Python3/BinaryTree/BinaryTreeZigzagLevelOrderTraversal/WithoutReverse2_103.py)|Need to be able to right without reverse version solution|-
...
|  106|Medium *|[Construct Binary Tree from Inorder and Postorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-inorder-and-postorder-traversal/)|2018/6/8|Binary Tree|[DC-O(n)](Python3/BinaryTree/ConstructBinaryTreefromInorderandPostorderTraversal/DivideAndConquer106.py), [Naive-O(n)](Python3/BinaryTree/ConstructBinaryTreefromInorderandPostorderTraversal/Naive106.py), [Naive 2-O(nlogn)](Python3/BinaryTree/ConstructBinaryTreefromInorderandPostorderTraversal/Naive2_106.py), [Naive 3-O(n)](Python3/BinaryTree/ConstructBinaryTreefromInorderandPostorderTraversal/Naive3_106.py), [Better-O(n)](Python3/BinaryTree/ConstructBinaryTreefromInorderandPostorderTraversal/Better106.py)|[Note](Python3/BinaryTree/ConstructBinaryTreefromInorderandPostorderTraversal/Note106.md)|test cases
...
|👍 112|Easy    |[Path Sum](https://leetcode.com/problems/path-sum/)|2018/6/8|Binary Tree|[Naive-O(n)](Python3/BinaryTree/PathSum/Naive112.py)|[Note](Python3/BinaryTree/PathSum/Note112.md)|Can be improved
...
|👍 121|Easy *  |[Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/)|2018/6/13|Array|[BruteForce-O(n)](Python3/Array/BestTimetoBuyandSellStock/BruteForce121.py), [Not so DP-O(n)](Python3/Array/BestTimetoBuyandSellStock/DP121.py), [Naive-O(n)](Python3/Array/BestTimetoBuyandSellStock/Naive121.py), [DP-O(n)](Python3/Array/BestTimetoBuyandSellStock/DP2_121.py)|[Note](Python3/Array/BestTimetoBuyandSellStock/Note121.md)|-
|👍 122|Medium *|[Best Time to Buy and Sell Stock II](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-ii/)|2018/6/14|Array|[Greedy-O(n)](Python3/Array/BestTimetoBuyandSellStockII/Greedy122.py), [Tricky-O(n)](Python3/Array/BestTimetoBuyandSellStockII/Tricky122.py), [Max-O(n)](Python3/Array/BestTimetoBuyandSellStockII/Max122.py), [Greedy 2-O(n)](Python3/Array/BestTimetoBuyandSellStockII/Greedy2_122.py)|[Note](Python3/Array/BestTimetoBuyandSellStockII/Note122.md)|-
...
|👍 129|Medium *|[Sum Root to Leaf Numbers](https://leetcode.com/problems/sum-root-to-leaf-numbers/)|2020/6/26|Binary Tree|[Naive-O(nlogn)](Python3/BinaryTree/SumRootToLeafNumbers/Naive129.py), [DFS-O(n)](Python3/BinaryTree/SumRootToLeafNumbers/DFS129.py), [Stack DFS-O(n)](Python3/BinaryTree/SumRootToLeafNumbers/StackDFS129.py)||-
...
|👍 133|Medium *|[Clone Graph](https://leetcode.com/problems/clone-graph/)|2020/1/16|Graph|[Recursive-O(n)](Python3/Graph/CloneGraph/Recursive133.py), [DFS-O(n)](Python3/Graph/CloneGraph/DFS133.py), [BFS-O(n)](Python3/Graph/CloneGraph/BFS133.py)|[Note](Python3/Graph/CloneGraph/Note133.md), Learn: Queue & Stack|Do it again
...
|👍 142|Medium *|[Linked List Cycle II](https://leetcode.com/problems/linked-list-cycle-ii/)|2020/6/25|Linked List|[Naive-O(n)](Python3/LinkedList/LinkedListCycleII/Naive142.py), [Two Pointer-O(n)](Python3/LinkedList/LinkedListCycleII/TwoPointer142.py), [Two Pointer 2-O(n)](Python3/LinkedList/LinkedListCycleII/TwoPointer2_142.py)||testcase
...
|👍 146|Medium *|[LRU Cache](https://leetcode.com/problems/lru-cache/)|2018/6/25|Design|[Naive](Python3/Design/LRUCache/Naive146.py), [Queue](Python3/Design/LRUCache/Queue146.py), [**OrderedDict**](Python3/Design/LRUCache/OrderedDict146.py), [**DoubleLinkedList**](Python3/Design/LRUCache/DoubleLinkedList146.py)|[Note](Python3/Design/LRUCache/Note146.md)|
...
|  165|Medium ▼|[Compare Version Numbers](https://leetcode.com/problems/compare-version-numbers/)|2023/2/23|String|[Naive-O(n)](Python3/String/CompareVersionNumbers/Naive167.py), [Improve-O(n)](Python3/String/CompareVersionNumbers/Improve167.py)||Follow up: [Sort an Array of Version Numbers](https://www.geeksforgeeks.org/sort-an-array-of-version-numbers/), testcase
...
|👍 208|Medium *|[Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree/)|2018/6/24|Design|[Naive](Python3/Design/ImplementTrie/Naive208.py), [Trie (using Hashmap)](Python3/Design/ImplementTrie/Trie208.py), [Trie (using Array)](Python3/Design/ImplementTrie/Trie_array208.py), [Trie 2 (using Hashmap)](Python3/Design/ImplementTrie/Trie2_208.py)|[Note](Python3/Design/ImplementTrie/Note208.md)|testcase
...
|👍 211|Medium *|[Add and Search Word - Data structure design](https://leetcode.com/problems/add-and-search-word-data-structure-design/)|2020/6/30|Design|[Naive](Python3/Design/AddAndSearchWord/Naive211.py), [RegEx](Python3/Design/AddAndSearchWord/RegEx211.py), [Tire](Python3/Design/AddAndSearchWord/Tire211.py), [Self as Tire](Python3/Design/AddAndSearchWord/Tire2_211.py)|[Note](Python3/Design/AddAndSearchWord/Note211.md)|do it again
...
|👍 226|Easy *  |[Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree/)|2020/6/1|Binary Tree|[Naive-O(n)](Python3/BinaryTree/InvertBinaryTree/Naive226.py), [Recursive-O(n)](Python3/BinaryTree/InvertBinaryTree/Recursive226.py)|[Note](Python3/BinaryTree/InvertBinaryTree/Note226.md)|testcase
...
|👍 259|Medium *|[3Sum Smaller](https://www.lintcode.com/problem/918/) ([premium](https://leetcode.com/problems/3sum-smaller/))|TODO|Array||Similar with 611|do it again
...
|👍 382|Medium *|[Linked List Random Node](https://leetcode.com/problems/linked-list-random-node/)|2023/3/10|Linked List|[Naive-O(n)](Python3/LinkedList/LinkedListRandomNode/Naive382.py), [Weighted Sampling-O(n)](Python3/LinkedList/LinkedListRandomNode/WeightedSampling382.py), [ReservoirSampling-O(n)](Python3/LinkedList/LinkedListRandomNode/ReservoirSampling382.py)||test cases
|   383|Easy    |[Ransom Note](https://leetcode.com/problems/ransom-note/)|2020/5/4|String|[Naive-O(n)](Python3/String/RansomNote/Naive383.py), [Better-O(n)](Python3/String/RansomNote/Better383.py)|-|-
...
|   392|Easy    |[Is Subsequence](https://leetcode.com/problems/is-subsequence/)|2020/6/9|String|[Naive-O(n)](Python3/String/IsSubsequence/Naive392.py)||-
...
|   427|Medium  |[Construct Quad Tree](https://leetcode.com/problems/construct-quad-tree/)|TODO|Graph|[Naive](Python3/Graph/ConstructQuadTree/Naive427.py)||
...
|   443|Medium  |[String Compression](https://leetcode.com/problems/string-compression/)|2023/3/2|String|[Naive-O(n)](Python3/String/StringCompression/Naive443.py), [Two Pointer-O(n)](Python3/String/StringCompression/TwoPointer443.py), [Two Pointer 2-O(n)](Python3/String/StringCompression/TwoPointer2_443.py)||-
...
|👍 502|Hard    |[IPO](https://leetcode.com/problems/ipo/)|2023/2/23|Array|[Naive-O(kn)](Python3/Array/IPO/Naive502.py), [SortHeap-O(nlogn)](Python3/Array/IPO/SortHeap502.py), [SortHeapImprove-O(nlogn)](Python3/Array/IPO/SortHeapImprove502.py)||-
|👍 503|Medium *|[Next Greater Element II](https://leetcode.com/problems/next-greater-element-ii/)|TODO|Array|||-
|👍 516|Medium *|[Longest Palindromic Subsequence](https://leetcode.com/problems/longest-palindromic-subsequence/)|2023/4/14|String|[Top-Down DP-O(n²)](Python3/String/LongestPalindromicSubsequence/TopDownDP516.py), [Bottom-Up DP-O(n²)](Python3/String/LongestPalindromicSubsequence/BottomUpDP516.py), [Bottom-Up DP-O(n²) O(n) space](Python3/String/LongestPalindromicSubsequence/BottomUpDPBetter516.py)||O(n) Space Bottom-Up DP, Follow Up (list result)
...
|👍 540|Medium  |[Single Element in a Sorted Array](https://leetcode.com/problems/single-element-in-a-sorted-array/)|2020/5/12|Array|[Naive-O(n)](Python3/Array/SingleElementInASortedArray/Naive540.py), [BinarySearchXOR-O(logn)](Python3/Array/SingleElementInASortedArray/BinarySearchXOR540.py), [XOR-O(n)](Python3/Array/SingleElementInASortedArray/XOR540.py), [BinarySearch-O(logn)](Python3/Array/SingleElementInASortedArray/BinarySearch540.py)||-
...
|  605|Easy    |[Can Place Flowers](https://leetcode.com/problems/can-place-flowers/)|2023/3/20|Array|[Naive-O(n)](Python3/Array/CanPlaceFlowers/Naive605.py)||-
|👍 611|Medium *|[Valid Triangle Number](https://leetcode.com/problems/valid-triangle-number/)|2023/2/28|Array|[Brute Force-O(n^3)](Python3/Array/ValidTriangleNumber/BruteForce611.py), [Binary Search-O(n^2logn)](Python3/Array/ValidTriangleNumber/BinarySearch611.py), [Binary Search 2-O(n^2logn)](Python3/Array/ValidTriangleNumber/BinarySearch2_611.py), [Two Pointer-O(n^2)](Python3/Array/ValidTriangleNumber/TwoPointer611.py)|Byte Dance Interview|-
...
|  704|Easy *  |[Binary Search](https://leetcode.com/problems/binary-search)|2020/5/9|Array|[Iterative(<)-O(logn)](Python3/Array/BinarySearch/Iterative704.py), [Recursive(<=)-O(logn)](Python3/Array/BinarySearch/Recursive704.py), [Bisect-O(logn)](Python3/Array/BinarySearch/Bisect704.py)||-
...
|👍 783|Easy    |[Minimum Distance Between BST Nodes](https://leetcode.com/problems/minimum-distance-between-bst-nodes/)|2023/2/17|Binary Tree|[DFS-O(n)](Python3/BinaryTree/MinimumDistanceBetweenBSTNodes/DFS783.py), [DFS Improve-O(n)](Python3/BinaryTree/MinimumDistanceBetweenBSTNodes/DFSImprove783.py)||testcase
...
|👍 834|Hard *  |[Sum of Distances in Tree](https://leetcode.com/problems/sum-of-distances-in-tree/)|2022/12/22|Graph|[Naive-O(n^3)](Python3/Graph/SumOfDistancesInTree/Naive834.py), [SubtreeSumAndCount-O(n)](Python3/Graph/SumOfDistancesInTree/SubtreeSumAndCount834.py)||do it again
|  841|Medium  |[Keys and Rooms](https://leetcode.com/problems/keys-and-rooms/)|2022/12/20|Graph|[DFS-O(n)](Python3/Graph/KeysAndRooms/DFS841.py), [DFS (loop)-O(n)](Python3/Graph/KeysAndRooms/DFS_loop841.py)||
|  842|Medium  |[Split Array into Fibonacci Sequence](https://leetcode.com/problems/split-array-into-fibonacci-sequence/)|2022/12/20|String|[Backtracking-O(n^m)](Python3/String/SplitArrayIntoFibonacciSequence/Backtracking842.py)||
...
|  867|Easy    |[Transpose Matrix](https://leetcode.com/problems/transpose-matrix/)|2023/2/21|Array|[Naive-O(n)](Python3/Array/TransposeMatrix/Naive867.py), [Numpy-O(n)](Python3/Array/TransposeMatrix/Numpy867.py)||testcase
|👍 870|Medium  |[Advantage Shuffle](https://leetcode.com/problems/advantage-shuffle/)|2023/3/9|Array|[Sorting-O(n)](Python3/Array/AdvantageShuffle/Sorting870.py), [SortingWithQueue-O(n)](Python3/Array/AdvantageShuffle/SortingWithQueue870.py)||-
...
|👍 881|Medium ▼|[Boats to Save People](https://leetcode.com/problems/boats-to-save-people/)|2023/4/3|Array|[Greedy-O(nlogn)](Python3/Array/BoatsToSavePeople/Greedy881.py)||Follow up: 1986
|👍 886|Medium *|[Possible Bipartition](https://leetcode.com/problems/possible-bipartition/)|2022/12/21|Graph|[BFS-O(n)](Python3/Graph/PossibleBipartition/BFS886.py)||do it again
...
|👍 904|Medium  |[Fruit Into Baskets](https://leetcode.com/problems/fruit-into-baskets/)|2023/2/7|Array|[Naive-O(n^2)](Python3/Array/FruitIntoBaskets/Naive904.py), [SlidingWindow-O(n)](Python3/Array/FruitIntoBaskets/SlidingWindow904.py), [Greedy-O(n)](Python3/Array/FruitIntoBaskets/Greedy904.py)||-
|👍 912|Medium *|[Sort an Array](https://leetcode.com/problems/sort-an-array/)|2023/3/1|Array|[Quick Sort-O(nlogn)](Python3/Array/SortAnArray/QuickSort912.py), [3-Way Quick Sort-O(nlogn) TODO](Python3/Array/SortAnArray/ThreeWayQuickSort912.py), [Heap Sort-O(nlogn)](Python3/Array/SortAnArray/HeapSort912.py), [Heap Sort 2-O(nlogn) TODO](Python3/Array/SortAnArray/HeapSort2_912.py), [Merge Sort-O(nlogn) TODO](Python3/Array/SortAnArray/MergeSort912.py)||Implement all other O(nlogn) sorting algorithms
...
|👍 946|Medium *|[Validate Stack Sequences](https://leetcode.com/problems/validate-stack-sequences/)|2023/4/13|Array|[Naive-O(n)](Python3/Array/ValidateStackSequences/Naive946.py), [Better-O(n)](Python3/Array/ValidateStackSequences/Better946.py)||-
...
|👍 958|Medium *|[Check Completeness of a Binary Tree](https://leetcode.com/problems/check-completeness-of-a-binary-tree/)|2023/3/15|Binary Tree|[BFS-O(n)](Python3/BinaryTree/CheckCompletenessOfABinaryTree/BFS958.py), [DFS-O(n)](Python3/BinaryTree/CheckCompletenessOfABinaryTree/DFS958.py)|[Note](Python3/BinaryTree/CheckCompletenessOfABinaryTree/Note958.md)|testcase, do it again
...
|  989|Easy    |[Add to Array-Form of Integer](https://leetcode.com/problems/add-to-array-form-of-integer/)|2023/2/15|Array|[Naive-O(n)](Python3/Array/AddToArrayFormOfInteger/Naive989.py), [Python-O(n)](Python3/Array/AddToArrayFormOfInteger/Python989.py)||-
...
|  997|Easy    |[Find the Town Judge](https://leetcode.com/problems/find-the-town-judge/)|2020/5/10|Array|[Naive-O(n)](Python3/Array/FindTheTownJudge/Naive997.py), [Improve-O(n)](Python3/Array/FindTheTownJudge/Improve997.py), [Naive 2-O(n)](Python3/Array/FindTheTownJudge/Naive2_997.py)||
...
|👍 1011|Medium *|[Capacity To Ship Packages Within D Days](https://leetcode.com/problems/capacity-to-ship-packages-within-d-days/)|2023/2/22|Array|[BinarySearch-O(nlogn)](Python3/Array/CapacityToShipPackagesWithinDDays/BinarySearch1011.py), [BinarySearchImprove-O(nlogn)](Python3/Array/CapacityToShipPackagesWithinDDays/BinarySearchImprove1011.py)||-
|👍 1020|Medium *|[Number of Enclaves](https://leetcode.com/problems/number-of-enclaves/)|2023/4/7|Graph|[DFS-O(n)](Python3/Graph/NumberOfEnclaves/DFS1020.py), [Simpler DFS-O(n)](Python3/Graph/NumberOfEnclaves/SimplerDFS1020.py)||-
...
|👍 1046|Easy *  |[Last Stone Weight](https://leetcode.com/problems/last-stone-weight/)|2020/4/12|Array|[Heap-O(nlogn)](Python3/Array/LastStoneWeight/Heap1046.py), [Insertion Sort-O(nlogn)](Python3/Array/LastStoneWeight/InsertionSort1046.py)||-
...
|👍  1091|Medium  |[Shortest Path in Binary Matrix](https://leetcode.com/problems/shortest-path-in-binary-matrix/)|2021/2/13|Graph|[Naive-O(n)](Python3/Graph/ShortestPathInBinaryMatrix/Naive1091.py)||testcase
...
|👍 1143|Medium *|[Longest Common Subsequence](https://leetcode.com/problems/longest-common-subsequence/)|2019/10/22|String|[Brute Force-O(2ⁿ)](Python3/String/LongestCommonSubsequence/BruteForce1143.py), [DP-O(mn)](Python3/String/LongestCommonSubsequence/DP1143.py)|[Note](Python3/String/LongestCommonSubsequence/Note1143.md), Baidu Interview (twice), [DP + Return Subsequence](Python3/String/LongestCommonSubsequence/DP_ReturnSubsequence.py)|Follow Up: [Nowcoder - Return Subsequence Itself](https://www.nowcoder.com/practice/6d29638c85bb4ffd80c020fe244baf11?tpId=196&tqId=37131&ru=/exam/oj)
...
|👍 1319|Medium  |[Number of Operations to Make Network Connected](https://leetcode.com/problems/number-of-operations-to-make-network-connected/)|2023/3/23|Graph|[DFS-O(n)](Python3/Graph/NumberOfOperationsToMakeNetworkConnected/DFS1319.py)||union find
|👍 1312|Hard *  |[Minimum Insertion Steps to Make a String Palindrome](https://leetcode.com/problems/minimum-insertion-steps-to-make-a-string-palindrome/)|2023/4/22|String|[Top-Down DP-O(n)](Python3/String/MinimumInsertionStepsToMakeAStringPalindrome/TopDownDP1312.py), [Bottom-Up DP-O(n) (TODO)](Python3/String/MinimumInsertionStepsToMakeAStringPalindrome/BottomUpDP.py)|Similar to 72 Edit Distance|Bottom-Up DP (see faster solution)
...
|👍 1444|Hard    |[Number of Ways of Cutting a Pizza]()|2023/3/31|Array|[Prefix Sum + DP-O(kmn)](Python3/Array/NumberOfWaysOfCuttingAPizza/PrefixSumDP1444.py)||do it again
|👍 1462|Medium *|[Course Schedule IV](https://leetcode.com/problems/course-schedule-iv/)|TODO|Array|-|-|-
|👍 1466|Medium *|[Reorder Routes to Make All Paths Lead to the City Zero](https://leetcode.com/problems/course-schedule-iv/)|2023/3/25|Graph|[BFS-O(n)](Python3/Graph/ReorderRoutesToMakeAllPathsLeadToTheCityZero/BFS1466.py)|-|do it again (faster), testcases
|   1472|Medium  |[Design Browser History](https://leetcode.com/problems/design-browser-history/)|2023/3/18|Design|[Naive](Python3/Design/DesignBrowserHistory/Naive1472.py)||testcase
...
|   1491|Easy    |[Average Salary Excluding the Minimum and Maximum Salary](https://leetcode.com/problems/average-salary-excluding-the-minimum-and-maximum-salary/)|2023/5/1|Array|[Naive-O(n)](Python3/Array/AverageSalaryExcludingtheMinimumAndMaximumSalary/Naive1491.py)|Good for beginner|-
|👍 1539|Easy    |[Kth Missing Positive Number](https://leetcode.com/problems/kth-missing-positive-number/)|2021/1/6|Array|[Naive-O(n+k)](Python3/Array/KthMissingPositiveNumber/Naive1539.py), [Naive 2-O(n)](Python3/Array/KthMissingPositiveNumber/Naive2_1539.py), [Binary Search-O(logn)](Python3/Array/KthMissingPositiveNumber/BinarySearch1539.py), [Bisect-O(logn)](Python3/Array/KthMissingPositiveNumber/Bisect1539.py)|-|-
...
|👍 1675|Hard    |[Minimize Deviation in Array](https://leetcode.com/problems/minimize-deviation-in-array/)|2023/2/24|Array|[Greedy-O(nlogn)](Python3/Array/MinimizeDeviationInArray/Greedy1675.py)||do it again, testcase
|   1768|Easy    |[Merge Strings Alternately](https://leetcode.com/problems/merge-strings-alternately/)|2023/4/18|String|[Naive-O(n)](Python3/String/MergeStringsAlternatively/Naive1768.py)|Good for beginner|-
|👍 1834|Medium  |[Single-Threaded CPU](https://leetcode.com/problems/single-threaded-cpu/)|2022/12/29|Array|[Greedy-O(n^2)](Python3/Array/SingleThreadedCPU/Greedy1834.py), [Heap-O(nlogn)](Python3/Array/SingleThreadedCPU/Heap1834.py), [HeapImprove-O(nlogn)](Python3/Array/SingleThreadedCPU/HeapImprove1834.py)||-
|   1822|Easy    |[Sign of the Product of an Array](https://leetcode.com/problems/sign-of-the-product-of-an-array/)|2023/5/2|Math|[Python-O(n)](Python3/Math/SignOfTheProductOfAnArray/Python1822.py), [Naive-O(n)](Python3/Math/SignOfTheProductOfAnArray/Naive1822.py), [Better-O(n)](Python3/Math/SignOfTheProductOfAnArray/Better1822.py)|Good for beginner|-
|👍 1861|Medium  |[Rotating the Box](https://leetcode.com/problems/rotating-the-box/)|TODO|AdHoc||Code Signal|-
|👍 1986|Medium *|[Minimum Number of Work Sessions to Finish the Tasks](https://leetcode.com/problems/minimum-number-of-work-sessions-to-finish-the-tasks/)|TODO|Array|||-
...
|👍 2099|Easy    |[Find Subsequence of Length K With the Largest Sum](https://leetcode.com/problems/find-subsequence-of-length-k-with-the-largest-sum/)|2023/2/23|Array|[Naive-O(n)](Python3/Array/FindSubsequenceOfLengthKWithTheLargestSum/Naive2099.py)||better testcase
|👍 2187|Medium  |[Minimum Time to Complete Trips](https://leetcode.com/problems/minimum-time-to-complete-trips/)|2023/3/7|Array|[Binary Search-O(nlogn)](Python3/Array/MinimumTimeToCompleteTrips/BinarySearch2187.py)||-
|👍 2244|Medium  |[Minimum Rounds to Complete All Tasks](https://leetcode.com/problems/minimum-rounds-to-complete-all-tasks/)|2023/1/4|Array|[Greedy-O(n)](Python3/Array/MinimumRoundsToCompleteAllTasks/Greedy2244.py), [Greedy2-O(n)](Python3/Array/MinimumRoundsToCompleteAllTasks/Greedy2_2244.py)||-
...
|👍 2316|Medium *▲|[Count Unreachable Pairs of Nodes in an Undirected Graph](https://leetcode.com/problems/count-unreachable-pairs-of-nodes-in-an-undirected-graph/)|2023/3/25|Graph|[Union Find (TLE) - O(n)](Python3/Graph/CountUnreachablePairsOfNodesInAnUndirectedGraph/UnionFind2316.py), [Union Find Improve - O(n)](Python3/Graph/CountUnreachablePairsOfNodesInAnUndirectedGraph/UnionFindImprove2316.py), [DFS-O(n)](Python3/Graph/CountUnreachablePairsOfNodesInAnUndirectedGraph/DFS2316.py), [BFS-O(n)](Python3/Graph/CountUnreachablePairsOfNodesInAnUndirectedGraph/BFS2316.py)||other solution, testcases
|👍 2348|Medium  |[Number of Zero-Filled Subarrays](https://leetcode.com/problems/number-of-zero-filled-subarrays/)|2023/3/21|Array|[Math-O(n)](Python3/Array/NumberOfZero-FilledSubarrays/Math2348.py), [Simplified Math-O(n)](Python3/Array/NumberOfZero-FilledSubarrays/SimplifiedMath2348.py)||other solutions
|👍 2360|Hard *  |[Longest Cycle in a Graph](https://leetcode.com/problems/longest-cycle-in-a-graph/)|2023/3/26|Graph|[DFS With Time-O(n)](Python3/Graph/LongestCycleInAGraph/DFSWithTime2360.py)||topological sort
|   2390|Medium ▼|[Removing Stars From a String]()|2023/4/11|String|[Stack-O(n)](Python3/String/RemovingStarsFromAString/Stack2390.py)||-
|👍 2405|Medium ▼|[Optimal Partition of String](https://leetcode.com/problems/optimal-partition-of-string/)|2023/4/4|String|[Greedy-O(n)](Python3/String/OptimalPartitionOfString/Greedy2405.py)||try other solution
|👍 2439|Medium ▲|[Minimize Maximum of Array](https://leetcode.com/problems/minimize-maximum-of-array/)|2023/4/5|Array|[GreedyBruteForce-O(n*max(nums))](Python3/Array/MinimizeMaximumOfArray/GreedyBruteForce2439.py), [Binary Search-O(n*max(nums))](Python3/Array/MinimizeMaximumOfArray/BinarySearch2439.py), [Prefix Sum-O(n)](Python3/Array/MinimizeMaximumOfArray/PrefixSum2439.py)||-
|👍 2492|Medium  |[Minimum Score of a Path Between Two Cities](https://leetcode.com/problems/minimum-score-of-a-path-between-two-cities/)|2023/3/23|Graph|[BFS-O(n)](Python3/Graph/MinimumScoreOfAPathBetweenTwoCities/BFS2492.py), [Union Find-O(n)](Python3/Graph/MinimumScoreOfAPathBetweenTwoCities/UnionFind2492.py)||DFS, Union-Find
